<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item <?= $aktif == 'checking' ? 'active' : '' ?>">
				<a class="nav-link" href="<?= base_url('checking/target') ?>">
					<i class="fas fa-fw fa-users"></i>
					<span>Target Checking</span></a>
			</li>
			...
			<li class="nav-item <?= $aktif == 'checking' ? 'active' : '' ?>">
				<a class="nav-link" href="<?= base_url('checking') ?>">
					<i class="fas fa-fw fa-file-invoice"></i>
					<span>Transaksi Checking</span></a>
			</li>
