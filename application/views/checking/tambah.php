				...
				<div class="row">
					<div class="col">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('checking/process_report') ?>" id="form-tambah" method="POST">
									<h5>Data Petugas</h5>
									<hr>
									<div class="form-row">
										...
										<div class="form-group col-4">
											...
											<input type="text" name="petugas_id" value="<?= $this->session->login['id'] ?>" readonly class="form-control">
										</div>
										<div class="form-group col-4">
										...
										<div class="col-md-12">
											...
											<div class="form-row">
												...
												<div class="form-group col-3">
													<label>Tanggal</label>
													<input type="date" name="tgl_checking" value="" class="form-control" min='1' onchange="getBarangByTanggal(this)">
												</div>
												<div class="form-group col-3">
													<label for="barang">Nama Barang</label>
													<select name="barang" id="barang" class="form-control" required onChange="getTarget(this)">
														<option value="" disabled selected>Pilih Barang</option>
													</select>
												</div>
												<div class="form-group col-2">
													<label>Target</label>
													<input type="number" name="target" id="target" value="" class="form-control" min='1' onchange="calculateKinerja()" readonly>
												</div>
												<div class="form-group col-2">
													<label>Hasil</label>
													<input type="number" name="hasil" id="hasil" value="" class="form-control" min='1' onkeyup="calculateKinerja()">
												</div>
												<div class="form-group col-2">
													<label>Kinerja</label>
													<div class="input-group">
												        <input type="number" name="kinerja" id="kinerja" value="" class="form-control" readonly>
